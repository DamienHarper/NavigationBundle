...
class FormatHelperTest extends TestCase
{
    public function testFormatTime(): void
    {
        ...
        $this->assertSame('5 mins 15 secs', FormatHelper::formatTime(315, true));
        ...
        $this->assertSame('3 hrs 5 secs', FormatHelper::formatTime(10805, true));
        $this->assertSame('3 hrs', FormatHelper::formatTime(10805));
        $this->assertSame('3 hrs 5 mins', FormatHelper::formatTime(11100, true));
        $this->assertSame('3 hrs', FormatHelper::formatTime(11100));
        $this->assertSame('1 day', FormatHelper::formatTime(86400));
        $this->assertSame('2 days 7 hrs 33 mins 20 secs', FormatHelper::formatTime(200000, true));
